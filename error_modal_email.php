...
<div id="myModal" class="modal">
  <div class="modal-content">
    ...
    <div class="modal-message">
        ...
        This email address has already been registered for the current ongoing college admission. <br> Please use a different email address.
    </div>
    <button class="modal-button" onclick="window.location.href='index.php'">Go to Registration</button>
  </div>
</div>
